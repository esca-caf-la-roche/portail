...
réservations de la salle les samedis après-midi, planning des salariés du
samedi et
...
3. **Sécurité par OTP** : le staff accède au portail si son email a été
   pré-enregistré. Les personnes autorisées à réserver la salle et les salariés
   du samedi utilisent chacun leur liste d'accès et leur écran de connexion
   dédiés. Les abonnés peuvent s'auto-inscrire,
...
Le module **Samedis après-midi** tient le carnet de réservation de la salle,
avec une réservation par samedi et par saison. Les participants autorisés choisissent une date libre depuis un
